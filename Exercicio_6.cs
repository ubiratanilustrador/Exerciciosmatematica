...
class Exercicio_6 {
  static void Main() {
	 ...
	 * coefientes*/
    Console.WriteLine("informe o coeficente de a");
    int a = Convert.ToInt32(Console.ReadLine()); 
    Console.WriteLine("informe o coeficente de b");
    int b = Convert.ToInt32(Console.ReadLine()); 
    Console.WriteLine("informe o coeficente de c");
	...
	* e servira de parametro no calculo das duas raizes*/
	...
	Console.WriteLine(" ");
	Console.WriteLine("raiz 1 = "+ raize_um(a,b,raizes)+" raize 2 = "+ raize_dois(a,b,raizes));
